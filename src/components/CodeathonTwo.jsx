        ...
        <div className="min-h-screen bg-transparent text-white pt-24 pb-12 px-4 relative z-10">
            <div className="container mx-auto">
                ...
                <div className="flex justify-between items-center mb-12 border-b border-[var(--primary-color)] pb-4">
                    <h1 className="text-3xl md:text-5xl font-nosifer text-[var(--primary-color)] drop-shadow-[0_0_10px_var(--primary-color)]">
                        Codeathon 2.0
                    </h1>
                    <Link
                        to="/"
                        className="px-3 py-2 md:px-6 md:py-2 border-2 border-[var(--primary-color)] text-[var(--primary-color)] font-nosifer text-xl tracking-widest uppercase rounded hover:bg-[var(--primary-color)] hover:text-white hover:shadow-[0_0_20px_var(--primary-color)] hover:scale-105 transition-all duration-300 bg-black/50 flex items-center gap-2"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
                    {socialLinks.map((item, index) => (
                        <div key={index} className="w-full max-w-[328px] flex flex-col items-center">
                            <div className="mb-4 text-xl font-bold text-[var(--primary-color)] w-full text-center drop-shadow-[0_0_5px_var(--primary-color)] font-nosifer tracking-wider">
                                {item.title}
                            </div>
