        ...
        <div className="min-h-screen bg-transparent text-white pt-24 pb-12 px-4 relative z-10">
            <div className="container mx-auto">
                ...
                <div className="flex flex-row justify-between items-center mb-20 border-b border-[var(--primary-color)] pb-10 gap-2">
                    ...
                    <Link
                        to="/"
                        className="px-3 py-2 md:px-6 md:py-2 border-2 border-[var(--primary-color)] text-[var(--primary-color)] strange-title text-xl tracking-widest uppercase rounded hover:bg-[var(--primary-color)] hover:text-white hover:shadow-[0_0_20px_var(--primary-color)] hover:scale-105 transition-all duration-300 bg-black/50 flex items-center gap-2"
