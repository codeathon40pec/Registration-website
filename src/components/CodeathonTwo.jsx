...
const CodeathonTwo = () => {
    ...
    return (
        <div className="min-h-screen bg-transparent text-white pt-24 pb-12 px-6 md:px-20 relative z-10">
            <div className="w-full md:container md:mx-auto">
                ...
                {/* Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 justify-items-center mt-8 md:mt-12">
