...
const Rules = () => {
    const rulesList = [
        ...
        { id: 14, title: "Pre-Requireties", desc: "For IoT-related problem statements, you need to bring the required materials such as sensors, cameras, and other necessary hardware components."},
    ];
